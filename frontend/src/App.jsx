        ...
        <div className="leaderboard">
          ...
          {leaderboard.map((p, i) => (
            <div key={p.studentId}>
              ...
              <span className="leaderboard-result"><small>{p.correctCount}/{p.totalQuestions} correct</small><strong>{p.score} pts</strong></span>
            </div>
          ))}
        </div>
      )}
